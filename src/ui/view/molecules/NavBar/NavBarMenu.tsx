...
const NavBarMenu = () => {
    return (
        <Box className={classes['nav-bar-menu']}>
            <Box className={classes['nav-bar-menu-item']}>
                <Button>
                    <Icon>
            ...
            <Box className={classes['nav-bar-menu-item']}>
                <Button>
                    <Avatar
                        size="small"
                        src="https://instagram.fhan3-2.fna.fbcdn.net/v/t51.2885-19/s150x150/112331157_764326777646280_8349960478372336396_n.jpg?_nc_ht=instagram.fhan3-2.fna.fbcdn.net&_nc_ohc=h5_ux_YvNv4AX-3j9Z_&tp=1&oh=034ab902659ba8c1df000c8117c7efd9&oe=603457D9"
                    />
                </Button>
            </Box>
        </Box>
